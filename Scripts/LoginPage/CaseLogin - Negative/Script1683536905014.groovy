...
WebUI.setEncryptedText(findTestObject('Object Repository/Login Page/Page_TestProject Demo/input_Password_password'), 'tzH6RvlfSTg=')

WebUI.click(findTestObject('Object Repository/Login Page/Page_TestProject Demo/button_Login'))

WebUI.verifyElementPresent(findTestObject('Login Page/Page_TestProject Demo/div_Password is invalid'), 0)
